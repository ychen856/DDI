...
if __name__ == "__main__":
    os.environ["CUDA_VISIBALE_DEVICES"] = "2"
    imageAmount = int(sys.argv[1])

    SocketToMaster = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    print("wait con")
    SocketToMaster.connect(('10.7.48.14', 5080))  # connect to worker 1
    #SocketToMaster.connect(('10.7.48.142', 5080))  # connect to worker 1
    print("conn")
